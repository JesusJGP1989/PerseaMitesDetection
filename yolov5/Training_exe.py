...
python classify/train.py --model yolov5s-cls.pt --data C:\Users\Carlos\Downloads\datasets\Persea-mites-detection2-4 --epochs 10 --batch-size 64 --imgsz 224 --lr0 0.001 --pretrained weights/yolov5s-cls.pt
